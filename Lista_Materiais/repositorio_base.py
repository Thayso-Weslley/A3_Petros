...
class RepositorioBase:
    ...
    def obter_todos_materiais(self):
        ...
        print(f"\n[DEBUG ENG] Olhando para a pasta: {self.pasta_catalogo}")
        if os.path.exists(self.pasta_catalogo):
            print(f"[DEBUG ENG] Conteúdo real detectado na pasta: {os.listdir(self.pasta_catalogo)}")
        else:
            print(f"[DEBUG ENG] ATENÇÃO: Essa pasta NÃO EXISTE no disco.")
        # ------------------------------
